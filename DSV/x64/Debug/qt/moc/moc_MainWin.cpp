...
QT_MOC_LITERAL(1, 8, 14), // "fileWidgetSate"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 5), // "state"
QT_MOC_LITERAL(4, 30, 16) // "setEnableToolBar"

    },
    "MainWin\0fileWidgetSate\0\0state\0"
    "setEnableToolBar"
};
...
void MainWin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->fileWidgetSate((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->setEnableToolBar(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainWin::fileWidgetSate)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MainWin::fileWidgetSate(bool _t1)
{
